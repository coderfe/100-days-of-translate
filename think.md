...
- [如何像程序员一样思考](#如何像程序员一样思考)
  - [你已经可以像程序员一样思考](#你已经可以像程序员一样思考)
  - [第一步：把问题分解为更小的问题](#第一步把问题分解为更小的问题)
  - [第二步：为每个小问题找到解决方法](#第二步为每个小问题找到解决方法)
  - [第三步：以连贯的方式组合解决方法](#第三步以连贯的方式组合解决方法)
  - [让我们来看一个真实的例子](#让我们来看一个真实的例子)
    - [这个按钮的标记是怎样的？](#这个按钮的标记是怎样的)
    - [这个按钮应该是什么样子？](#这个按钮应该是什么样子)
    - [当按钮点击一次，两次，三次，分别会发生什么？](#当按钮点击一次两次三次分别会发生什么)
    - [侧边栏的标记是怎样的？](#侧边栏的标记是怎样的)
    - [侧边栏显示的时候是什么样子？](#侧边栏显示的时候是什么样子)
    - [侧边栏隐藏的时候是什么样子？](#侧边栏隐藏的时候是什么样子)
    - [你怎么知道侧边栏是隐藏的还是显示的？](#你怎么知道侧边栏是隐藏的还是显示的)
    - [怎样设置隐藏的侧边栏的样式？](#怎样设置隐藏的侧边栏的样式)
    - [侧边栏如何显示出来？](#侧边栏如何显示出来)
    - [侧边栏如何隐藏？](#侧边栏如何隐藏)
    - [页面加载时是否应该展示侧边栏？](#页面加载时是否应该展示侧边栏)
    - [如何知道你何时点击按钮？](#如何知道你何时点击按钮)
    - [第一次点击按钮会发生什么？](#第一次点击按钮会发生什么)
    - [再次点击按钮会发生什么？](#再次点击按钮会发生什么)
  - [重构并提升](#重构并提升)
  - [总结](#总结)
